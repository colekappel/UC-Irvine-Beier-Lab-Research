...
theInfoScore = [];
theInfoScore=transpose(infoScorePlaceCells);
...
for i = 1:height(eventRatePerBinMatx1)
   stability1v2(i)=atan(corr(transpose(eventRatePerBinMatx1(i,1:width(eventRatePerBinMatx1))),transpose(eventRatePerBinMatx2(i,1:width(eventRatePerBinMatx1))),'type','Pearson')^2);
...
for i = 1:height(eventRatePerBinMatx11)
   stabilityOddEven(i)=atan(corr(transpose(eventRatePerBinMatx11(i,1:width(eventRatePerBinMatx11))),transpose(eventRatePerBinMatx22(i,1:width(eventRatePerBinMatx11))),'type','Pearson')^2);
...
save(filename,"stabilityAverage","stability1v2","stabilityOddEven",...
    ...
    "erPlaceCells","ampPlaceCells","sparsityPlaceCells")
end